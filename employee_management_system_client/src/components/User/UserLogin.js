    ...
    axios({
      ...
      .then(function (response) {
        ...
        if (response.data.user_id) {
          ...
          window.sessionStorage.setItem("user_level_id", response.data.user_level_id);
          window.sessionStorage.setItem("user_name", response.data.user_first_name+" "+response.data.user_last_name);
          navigate("/dashboard")
        } else {
